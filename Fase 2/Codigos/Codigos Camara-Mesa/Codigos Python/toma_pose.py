...
def getRobot_Code(calib_snapshot, Canny_inf, Canny_sup, Medida_cod):
    ...
    return RecCod, gray_blur_img, canny_img #return temporal para la prueba multihilos.
...
def getRobot_fromSnapshot(RecContorno, snap, codeSize):
    ...
    if ctrl == 1:
        ...
        return tempID, "", pos #Robot(tempID,"", pos) #si ctrl es 1, se retorna el valor correcto
    return None
